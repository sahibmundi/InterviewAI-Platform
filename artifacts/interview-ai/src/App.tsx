...
import {
  ...
  getListInterviewsQueryKey, useCreateInterview, useGetDashboard, useGetInterview,
  useGetProfile, useHealthCheck, useListInterviews, useUpdateProfile,
...
function InterviewNewPage() {
  ...
  const submit = (event: FormEvent) => { event.preventDefault(); create.mutate({ data: input }, { onSuccess: (interview) => setLocation(`/interviews/${interview.id}`) }); };
